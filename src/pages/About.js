...
class About extends React.Component {
  ...
  /* componentDidMount() {
    const imageCycleInterval = window.setInterval(1000, this.setState(this.imageCycle));
  }

  imageCycle(state, props) {
    return
  } */
  render() {
    return (
 ...
 display: 'inline',
    marginRight: '2vh',
        ...
        <EquiptmentFinanced id="Equipt">
          ...
          <EquiptList>
            <IMG
              sizes={this.state.equiptmentImages[0]}
              outerWrapperClassName="coverOuter"
              position="absolute"
              style={gatsbyImgStyle}
            />
